/* \file       Readers/TextReader.h
*  \brief      Contains the declaration of the text reader class.
...
#ifndef READERS_TEXTREADER_H_INCLUDED
#define READERS_TEXTREADER_H_INCLUDED
...
namespace gw2b {
    ...
    public:
        ...
        *  \param[in]  p_fileType   File type of the given data. */
        TextReader( const Array<byte>& p_data, DatFile& p_datFile, ANetFileType p_fileType );
...
#endif // READERS_TEXTREADER_H_INCLUDED
